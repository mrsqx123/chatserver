...
#define CONFIG_MFG_ENV_SETTINGS \
	...
	#define CONFIG_EXTRA_ENV_SETTINGS \
		...
		"script=boot.scr\0" \
		"image=zImage\0" \
		"ipaddr=192.168.0.55\0" \
		"gatewayip=192.168.0.1\0" \
		"serverip=192.168.0.87\0" \
		"ip_dyn=yes\0" \
		"splashimage=0x8c000000\0" \
		"eth1addr 00:01:3f:2d:3e:4d\0" \
		"bootargs=console=ttymxc0,115200 root=/dev/mmcblk1p2 rootwait rw \0" \
		"bootcmd=tftp 80800000 zImage;" \
			"tftp 83000000 imx_linux.dtb;" \
...
/*#define CONFIG_EXTRA_ENV_SETTINGS \
		...
		"fdt_high=0xffffffff\0" \
		"initrd_high=0xffffffff\0" \
		"fdt_file=imx6ull-sqx-emmc.dtb\0" \
		"fdt_addr=0x83000000\0" \
		"tee_addr=0x84000000\0" \
		...
		"ip_dyn=yes\0" \
		"splashimage=0x8c000000\0" \
		"setenv eth1addr 00:01:3f:2d:3e:4d\0" \
		"setenv bootargs 'console=ttyS0,115200 root=/dev/mmcblk0p2 rootwait\0" \
